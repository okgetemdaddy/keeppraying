...
export function SuggestionBanner({ onClick }: Props) {
  return (
    <motion.button
      ...
      className="absolute left-[12%] top-full z-20 flex items-center gap-1.5 rounded-b-xl border border-t-0 border-slate-600/50 bg-slate-800 dark:bg-slate-900 px-3 py-1.5 shadow-md hover:bg-slate-700 dark:hover:bg-slate-800 transition-colors cursor-pointer group"
