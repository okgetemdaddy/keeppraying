...
const FEATURES = [
  ...
  {
    id: "world",
    title: "Pray the World",
    headline: "Cover the Globe in Prayer",
    body: "An interactive world map showing where prayers are rising. Tap a region, pray for the nations, and see the global body of Christ interceding together.",
    href: "/pray-the-world",
    Svg: WorldSvg,
