    ...
    <div className="min-h-screen bg-background">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-16">
        ...
        >
          ...
          {/* Beta notice */}
          <motion.p variants={fadeUp} className="inline-block bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl px-5 py-3 text-[hsl(270,60%,70%)] text-xs sm:text-sm font-body tracking-wide max-w-2xl">
